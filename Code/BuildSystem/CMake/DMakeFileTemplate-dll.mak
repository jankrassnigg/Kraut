...
ARCH_FLAG=-m64
DFLAGS_GENERAL=-c -shared @DINCLUDE_DIRS_FMT@
...
LFLAGS_GENERAL=/NODEFAULTLIB:libcmt /DLL /NOLOGO /LIBPATH:"$(VCInstallDir)" /LIBPATH:"$(WindowsSdkDir)" /LIBPATH:"@EZ_DMD_PATH@\..\lib64" /IGNORE:4049
LFLAGS_DEBUG=/NODEFAULTLIB:msvcrt msvcrtd.lib phobos64ds.lib /IMPLIB:"$(OUTPUT_LIB_DEBUG)/ez@PROJECT_NAME@.lib" /DEBUG
LFLAGS_RELEASE=msvcrt.lib phobos64s.lib /IMPLIB:"$(OUTPUT_LIB_RELEASE)/ez@PROJECT_NAME@.lib" /INCREMENTAL:NO
LFLAGS_MINSIZE=msvcrt.lib phobos64s.lib /IMPLIB:"$(OUTPUT_LIB_MINSIZE)/ez@PROJECT_NAME@.lib" /INCREMENTAL:NO
LFLAGS_RELWITHDEB=msvcrt.lib phobos64s.lib /IMPLIB:"$(OUTPUT_LIB_RELWITHDEB)/ez@PROJECT_NAME@.lib" /DEBUG /INCREMENTAL:NO
