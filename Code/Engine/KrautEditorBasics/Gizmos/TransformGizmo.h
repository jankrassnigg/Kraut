...
#include <KrautFoundation/Utility/EnumerableClass.h>
...
namespace AE_NS_EDITORBASICS
{
  ...
  public:
    ...
    //! Will return the currently dragged gizmo (or NULL).
    ...
    static bool IsDraggingGizmo () { return s_pCurrentlyDragged != NULL; }
