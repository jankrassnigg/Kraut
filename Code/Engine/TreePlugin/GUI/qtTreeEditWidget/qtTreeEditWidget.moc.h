...
#define SLIDER_UNDO(name) void qtTreeEditWidget::on_##name##_sliderPressed () { aeUndo::BeginOperation (); } \
...
public:
  ...
  void SetCurrentlyEditedBranchType (aeBranchType::Enum Type, bool bForce);
  void SetCurrentlyEditedLoD (aeLod::Enum LoD);
  aeBranchType::Enum GetCurrentlyEditedBranchType (void) const { return m_CurrentlyEditedType; }
  bool SaveTree (void);
...
private:
  ...
  aeBranchType::Enum m_CurrentlyEditedType;
  aeSpawnNodeDesc* m_pCurNT;
