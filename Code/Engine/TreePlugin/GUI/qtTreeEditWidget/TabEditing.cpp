...
{
  if ((param0.iInt32 != -1) && (g_Tree.m_Branches[param0.iInt32].m_bManuallyCreated))
  {
...
{
  g_Tree.m_Descriptor.m_bGrowProceduralTrunks = check_CreateProcedural->isChecked ();
