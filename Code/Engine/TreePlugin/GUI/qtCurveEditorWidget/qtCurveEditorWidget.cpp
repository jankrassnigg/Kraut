...
qtCurveEditorWidget* qtCurveEditorWidget::s_pWidget = NULL;

qtCurveEditorWidget::qtCurveEditorWidget (QWidget* parent) : QDockWidget (parent)
{
  s_pWidget = this;
...
aeCurve* qtCurveEditorWidget::GetCurve () const 
{ 
...
static void CreateCurveS (aeCurve& c, aeUInt32 uiStart, aeUInt32 uiRange, bool bInvert, float fPower)
{
...
void qtCurveEditorWidget::on_actionLoadPreset_triggered ()
{
  ...
  aeFileSystem::MakeValidPath ("Curves/", false, &sPrevPreset, NULL);
