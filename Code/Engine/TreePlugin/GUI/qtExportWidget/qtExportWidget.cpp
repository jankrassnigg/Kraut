...
aeFilePath qtExportWidget::s_sExportPath = "";
...
qtExportWidget::qtExportWidget (QWidget *parent) : QDialog(parent)
{
  ...
  {
    aeFilePath sName = aePathFunctions::GetFileName (g_Tree.m_sTreeFile);
...
void qtExportWidget::RunViewer (void)
{
  ...
  aeFilePath sWorkingDir = aePathFunctions::GetFileDirectory (CVar_ViewerApp.GetValue ());
