...
namespace AE_NS_FOUNDATION
{
  ...
  */
  ...
  protected:
    //! Non-instanciable from outside.
    explicit aeBasicString (char* pReadData, aeUInt32 uiLength) : m_pDataToRead (pReadData), m_uiLength (uiLength) 
    {
      ...
      AE_CHECK_DEV (pReadData != NULL, "aeBasicString::Constructor: pReadData must not be NULL. Initialize it with \"\" instead.");
    }
