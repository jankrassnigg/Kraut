...
namespace AE_NS_FOUNDATION
{
  ...
  */
  ...
  // Export these instanciations of the template from the DLL
    ...
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<8>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<12>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<16>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<24>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<32>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<48>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<64>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<128>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<256>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<512>;
    AE_EXPIMP_TEMPLATE_CLASS aeHybridString<1024>;
