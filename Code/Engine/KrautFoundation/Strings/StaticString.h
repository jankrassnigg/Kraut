...
namespace AE_NS_FOUNDATION
{
  ...
  /*! Fixed strings can hold exactly SIZE-1 characters plus the \0 terminator.
      ...
      memory allocations are done at all, which can often be desireable.\n
      \n
  ...
  */
  ...
  // Export these instanciations of the template from the DLL
    ...
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<8>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<12>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<16>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<24>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<32>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<48>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<64>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<128>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<256>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<512>;
    AE_EXPIMP_TEMPLATE_CLASS aeStaticString<1024>;
