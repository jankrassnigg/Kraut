...
namespace AE_NS_FOUNDATION
{
  ...
  public: \
    ...
    { \
      --s_uiInstances; \
      aeEnumerableClass_##EC* pPrev = NULL; \
  ...
  #define AE_MAKE_ENUMERABLE(EC) \
    public aeEnumerableClass_##EC

  #define AE_ENUMERABLE_CLASS_CODE(EC) \
    aeEnumerableClass_##EC* aeEnumerableClass_##EC::s_pFirstInstance = NULL; \
    aeEnumerableClass_##EC* aeEnumerableClass_##EC::s_pLastInstance = NULL; \
