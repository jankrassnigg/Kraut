...
#include "../_Externals/Lua/lua.h"
#include "../_Externals/Lua/lualib.h"
#include "../_Externals/Lua/lauxlib.h"
...
namespace AE_NS_FOUNDATION
{
  ...
  */
  class AE_FOUNDATION_DLL aeLuaWrapper
  {
  public:
    ...
    bool ExecuteString (const aeBasicString& sString, aeString* pError = NULL) const;
  ...
  private:
    ...
    struct AE_FOUNDATION_DLL aeScriptStates
    {
      aeScriptStates (void) : m_iParametersPushed (0), m_iOpenTables (0), m_iLuaReturnValues (0) {}
