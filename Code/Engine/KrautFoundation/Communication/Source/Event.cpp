...
namespace AE_NS_FOUNDATION
{
  ...
  */
  ...
  {
    AE_CHECK_DEV (callback != NULL, "aeEvent::RegisterEventReceiver: Callback may not be NULL."); 
  ...
  */
  ...
  {
    AE_CHECK_DEV (callback != NULL, "aeEvent::UnregisterEventReceiver: Callback may not be NULL.");
