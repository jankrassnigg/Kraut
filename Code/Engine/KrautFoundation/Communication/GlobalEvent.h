...
namespace AE_NS_FOUNDATION
{
  ...
  union AE_FOUNDATION_DLL aeGlobalEventParam
  {
    aeGlobalEventParam (void)                                             { Ptr = NULL; }
    aeGlobalEventParam (void* p)                                          { Ptr = p; }
    aeGlobalEventParam (aeInt32 i1)                                       { iInt32 = i1; }
    aeGlobalEventParam (aeInt16 i1, aeInt16 i2)                           { iInt16[0] = i1; iInt16[1] = i2; }
    aeGlobalEventParam (float f1)                                         { Float = f1; }
    aeGlobalEventParam (const char* sz)                                   { Text = sz; }
    aeGlobalEventParam (aeUInt8 i1, aeUInt8 i2, aeUInt8 i3, aeUInt8 i4)   { uiByte[0] = i1; uiByte[1] = i2; uiByte[2] = i3; uiByte[3] = i4; }
  ...
  */
  class AE_FOUNDATION_DLL aeGlobalEvent
  {
  public:
