...
{
  class AE_FOUNDATION_DLL aeDataDirectoryFileReaderWindows : public aeDataDirectoryFileReader
  {
  public:
  ...
  class AE_FOUNDATION_DLL aeDataDirectoryFileWriterWindows : public aeDataDirectoryFileWriter
  {
  public:
  ...
  class AE_FOUNDATION_DLL aeDataDirectoryHandler_Windows : public aeDataDirectoryHandler
  {
  public:
    ...
    //virtual void EnumFilesInDirectory (const char* szDirectory, bool bRecursive, CALLBACK, void* pPassThrough = NULL);
