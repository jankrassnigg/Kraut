...
/*! The aeResourceTemplate is a Helper-Sandwish-class, which implements type-specific functions,
  that are necessary for the aeResourceManager to work with a aeResource. It is a template, which
  allows the compiler to auto-generate these type-specific functions, removing this responsibilty
  ...
  if savegames (files with embedded resources) need to stay compatible.\n
...
public: \
  ...
  AE_INLINE static const char* GetResourceTypeNameStatic (void) {return s_ResourceTypeName.c_str ();} \
  \
private: \
  /*! returns the auto-generated class-name of this resource-type */ \
