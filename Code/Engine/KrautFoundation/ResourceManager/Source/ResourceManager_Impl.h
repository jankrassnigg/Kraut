...
#include <KrautFoundation/Threading/CriticalSection.h>
...
{
  struct AE_FOUNDATION_DLL aeResourceType
	{
		...
		aeFilePath m_sFallbackResource;
	};
	...
	struct AE_FOUNDATION_DLL aeResourceLoadState
	{
	...
	struct AE_FOUNDATION_DLL aeResManImpl
	{
	public:
