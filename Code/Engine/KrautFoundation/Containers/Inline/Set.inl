#ifndef AE_FOUNDATION_CONTAINERS_SET_INL
#define AE_FOUNDATION_CONTAINERS_SET_INL
...
namespace AE_NS_FOUNDATION
{
  ...
  void aeSet<KEY, COMPARE>::iterator_base::forward (void)
  {
    const int dir0 = 0;
    const int dir1 = 1;
    ...
    if (m_pElement == NULL)
    {
      AE_CHECK_ALWAYS (m_pElement != NULL, "aeSet::iterator_base::forward: The iterator is invalid (end).");
      return;
    }
  ...
  template < class KEY, class COMPARE>
  void aeSet<KEY, COMPARE>::iterator_base::backward (void)
  {
    const int dir0 = 1;
    const int dir1 = 0;
    ...
    if (m_pElement == NULL)
    {
      AE_CHECK_ALWAYS (m_pElement != NULL, "aeSet::iterator_base::backward: The iterator is invalid (end).");
      return;
    }
  ...
  template < class KEY, class COMPARE>
  aeSet<KEY, COMPARE>::aeNode::aeNode (void) : m_uiLevel (0), m_pParent (NULL)
  {
  }

  template < class KEY, class COMPARE>
  aeSet<KEY, COMPARE>::aeSet (void)
  {
    m_uiSize = 0;
  ...
  template < class KEY, class COMPARE>
  aeSet<KEY, COMPARE>::aeSet (const aeSet<KEY, COMPARE>& cc)
  {
    m_uiSize = 0;
  ...
  template < class KEY, class COMPARE>
  aeSet<KEY, COMPARE>::~aeSet ()
  {
    clear ();
  }

  template < class KEY, class COMPARE>
  void aeSet<KEY, COMPARE>::operator= (const aeSet<KEY, COMPARE>& rhs)
  {
    clear ();
  ...
  template < class KEY, class COMPARE>
  void aeSet<KEY, COMPARE>::clear (void)
  {
    iterator it = begin ();
  ...
  template < class KEY, class COMPARE>
  bool aeSet<KEY, COMPARE>::empty (void) const
  {
    return (m_uiSize == 0);
  }

  template < class KEY, class COMPARE>
  aeUInt32 aeSet<KEY, COMPARE>::size (void) const
  {
    return (m_uiSize);
  }

  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::iterator aeSet<KEY, COMPARE>::begin (void)
  {
    return (iterator (GetLeftMost ()));
  }

  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::iterator aeSet<KEY, COMPARE>::end (void)
  {
    return (iterator (NULL));
  }

  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::const_iterator aeSet<KEY, COMPARE>::begin (void) const
  {
    return (const_iterator (GetLeftMost ()));
  }

  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::const_iterator aeSet<KEY, COMPARE>::end (void) const
  {
    return (const_iterator (NULL));
  }

  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::reverse_iterator aeSet<KEY, COMPARE>::rbegin (void)
  {
    return (reverse_iterator (GetRightMost ()));
  }

  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::reverse_iterator aeSet<KEY, COMPARE>::rend (void)
  {
    return (reverse_iterator (NULL));
  }

  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::const_reverse_iterator aeSet<KEY, COMPARE>::rbegin (void) const
  {
    return (const_reverse_iterator (GetRightMost ()));
  }

  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::const_reverse_iterator aeSet<KEY, COMPARE>::rend (void) const
  {
    return (const_reverse_iterator (NULL));
  }

  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::aeNode* aeSet<KEY, COMPARE>::GetLeftMost (void) const
  {
    if (empty ())
      return (NULL);
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::aeNode* aeSet<KEY, COMPARE>::GetRightMost (void) const
  {
    if (empty ())
      return (NULL);
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::iterator aeSet<KEY, COMPARE>::find (const KEY& key)
  {
    aeNode* pNode = m_pRoot;
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::const_iterator aeSet<KEY, COMPARE>::find (const KEY& key) const
  {
    aeNode* pNode = m_pRoot;
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::iterator aeSet<KEY, COMPARE>::lower_bound (const KEY& key)
  {
    aeNode* pNode = m_pRoot;
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::iterator aeSet<KEY, COMPARE>::upper_bound (const KEY& key)
  {
    aeNode* pNode = m_pRoot;
    aeNode* pNodeSmaller = NULL;
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::const_iterator aeSet<KEY, COMPARE>::lower_bound (const KEY& key) const
  {
    aeNode* pNode = m_pRoot;
    aeNode* pNodeSmaller = NULL;
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::const_iterator aeSet<KEY, COMPARE>::upper_bound (const KEY& key) const
  {
    aeNode* pNode = m_pRoot;
    aeNode* pNodeSmaller = NULL;
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::iterator aeSet<KEY, COMPARE>::insert (const KEY& key)
  {
  ...
  template < class KEY, class COMPARE>
  void aeSet<KEY, COMPARE>::erase (const KEY& key)
  {
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::aeNode* aeSet<KEY, COMPARE>::AccquireNode (const KEY& key, int m_uiLevel, aeNode* pParent)
  {
    aeNode* pNode;
  ...
  template < class KEY, class COMPARE>
  void aeSet<KEY, COMPARE>::ReleaseNode (aeNode* pNode)
  {
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::aeNode* aeSet<KEY, COMPARE>::SkewNode (aeNode* root)
  {
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::aeNode* aeSet<KEY, COMPARE>::SplitNode (aeNode* root)
  {
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::aeNode* aeSet<KEY, COMPARE>::insert (aeNode* root, const KEY& key, aeNode*& pInsertedNode)
  {
    if (root == &m_NilNode)
    {
      pInsertedNode = AccquireNode (key, 1, &m_NilNode);
      root = pInsertedNode;
    }
    else 
    {
      ...
      pInsertedNode = AccquireNode (key, 1, it);
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::aeNode* aeSet<KEY, COMPARE>::erase (aeNode* root, const KEY& key)
  {
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::iterator aeSet<KEY, COMPARE>::erase (const iterator& pos)
  {
    AE_CHECK_ALWAYS (!empty (), "aeSet::erase: The container is empty.");
    AE_CHECK_ALWAYS (pos.m_pElement != NULL, "aeSet::erase: The iterator (pos) is invalid.");
  ...
  template < class KEY, class COMPARE>
  typename aeSet<KEY, COMPARE>::reverse_iterator aeSet<KEY, COMPARE>::erase (const reverse_iterator& pos)
  {
    AE_CHECK_ALWAYS (!empty (), "aeSet::erase: The container is empty.");
    AE_CHECK_ALWAYS (pos.m_pElement != NULL, "aeSet::erase: The reverse_iterator (pos) is invalid.");
