...
{
  static aeMap<aeHybridString<32>, aeDeque<AE_GLOBAL_EVENT_RECEIVER>>* s_pGlobalEvents = nullptr;
  static aeMap<aeHybridString<32>, aeDeque<AE_GLOBAL_EVENT_RECEIVER>>* s_pGlobalEventsOnce = nullptr;
  ...
  aeGlobalEvent::aeGlobalEvent(const char* szEventName, AE_GLOBAL_EVENT_RECEIVER Receiver, bool bHandleEventOnlyOnce)
  {
    ...
    {
      if (s_pGlobalEventsOnce == nullptr)
