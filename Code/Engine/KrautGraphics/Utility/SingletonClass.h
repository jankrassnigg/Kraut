...
namespace AE_NS_FOUNDATION
{
  ...
  //
  //   AE_SINGLETON_CLASS (linkage, A); // with linkage being AE_STATIC_LINKAGE or something else, see AE_GRAPHICS_DLL for an example
...
#define AE_SINGLETON_CLASS(linkage, EC)                                                     \
  ...
  public:                                                                                   \
    ...
    {                                                                                       \
      AE_CHECK_ALWAYS(s_pInstance == nullptr, "Singleton of Class '%s' already exists.", #EC); \
      s_pInstance = this;                                                                   \
    }                                                                                       \
                                                                                            \
    ...
    {                                                                                       \
      AE_CHECK_DEV(s_pInstance != nullptr, "No Instance of class '%s' exists!", #EC);          \
...
#define AE_SINGLETON_CLASS_CODE(EC) \
  aeSingletonClass_##EC* aeSingletonClass_##EC::s_pInstance = nullptr;
} // namespace AE_NS_FOUNDATION
