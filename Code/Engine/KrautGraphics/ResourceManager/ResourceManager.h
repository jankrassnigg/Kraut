...
#include <KrautGraphics/ResourceManager/Declarations.h>
...
namespace AE_NS_FOUNDATION
{
  /*!	The one-and-only global Manager for all Resources used inside the Engine.\n
	...
	*/
  class AE_GRAPHICS_DLL aeResourceManager
  {
  public:
  ...
  public:
    ...
    static const aeString GetFileResourceWasLoadedFrom(const aeResourceHandle& hRes);
