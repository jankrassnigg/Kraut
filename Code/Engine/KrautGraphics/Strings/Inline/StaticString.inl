...
namespace AE_NS_FOUNDATION
{
  ...
  aeStaticString<SIZE>::aeStaticString(void)
  ...
  template <aeUInt16 SIZE>
  aeStaticString<SIZE>::aeStaticString(const aeBasicString& cc)
    : aeBasicString(&m_String[0], 0)
  {
    operator=(cc);
  }
  ...
  template <aeUInt16 SIZE>
  aeStaticString<SIZE>::aeStaticString(const aeStaticString<SIZE>& cc)
    : aeBasicString(&m_String[0], 0)
  {
    operator=(cc);
  }
  ...
  template <aeUInt16 SIZE>
  aeStaticString<SIZE>::aeStaticString(const char* cc)
    : aeBasicString(&m_String[0], 0)
  {
    operator=(cc);
  }
  ...
  template <aeUInt16 SIZE>
  aeStaticString<SIZE>::aeStaticString(const char* cc, aeUInt32 uiMaxChars)
    : aeBasicString(&m_String[0], 0)
  {
  ...
  */
  ...
  template <aeUInt16 SIZE>
  inline char& aeStaticString<SIZE>::operator[](aeUInt32 index)
  {
  ...
  template <aeUInt16 SIZE>
  inline void aeStaticString<SIZE>::ToUpperCase(void)
  {
    aeStringFunctions::ToUpperCase(m_pDataToRead);
  }

  template <aeUInt16 SIZE>
  inline void aeStaticString<SIZE>::ToLowerCase(void)
  {
