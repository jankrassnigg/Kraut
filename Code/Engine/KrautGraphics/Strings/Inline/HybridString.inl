...
namespace AE_NS_FOUNDATION
{
  ...
  inline aeUInt32 aeHybridString<SIZE>::ComputeStringCapacity(aeUInt32 uiStringLength)
  {
  ...
  template <aeUInt32 SIZE>
  aeHybridString<SIZE>::aeHybridString(void)
    : aeBasicString(&m_String[0], 0)
    , m_uiCapacity(SIZE)
  {
    m_pDataToRead[0] = '\0';
  }
  ...
  template <aeUInt32 SIZE>
  aeHybridString<SIZE>::aeHybridString(const aeBasicString& cc)
    : aeBasicString(&m_String[0], 0)
    , m_uiCapacity(SIZE)
  {
    m_pDataToRead[0] = '\0';
  ...
  template <aeUInt32 SIZE>
  aeHybridString<SIZE>::aeHybridString(const aeHybridString<SIZE>& cc)
    : aeBasicString(&m_String[0], 0)
    , m_uiCapacity(SIZE)
  {
    m_pDataToRead[0] = '\0';
  ...
  template <aeUInt32 SIZE>
  aeHybridString<SIZE>::aeHybridString(const char* cc)
    : aeBasicString(&m_String[0], 0)
    , m_uiCapacity(SIZE)
  {
    m_pDataToRead[0] = '\0';
  ...
  template <aeUInt32 SIZE>
  aeHybridString<SIZE>::aeHybridString(const char* cc, aeUInt32 uiMaxChars)
    : aeBasicString(&m_String[0], 0)
    , m_uiCapacity(SIZE)
  {
    m_pDataToRead[0] = '\0';
  ...
  {
    AE_CHECK_DEV(szFormat != nullptr, "aeHybridString::FormatArgs: Cannot work with a nullptr-String as Format.");
  ...
  {
    AE_CHECK_DEV(szReplaceWith != nullptr, "aeHybridString::ReplaceSubString: Cannot replace something with a nullptr-string.");
  ...
  template <aeUInt32 SIZE>
  inline char& aeHybridString<SIZE>::operator[](aeUInt32 index)
  {
  ...
  template <aeUInt32 SIZE>
  inline void aeHybridString<SIZE>::ToUpperCase(void)
  {
    aeStringFunctions::ToUpperCase(m_pDataToRead);
  }

  template <aeUInt32 SIZE>
  inline void aeHybridString<SIZE>::ToLowerCase(void)
  {
