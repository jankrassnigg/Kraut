...
namespace AE_NS_GRAPHICS
{
  ...
  bool TGALoaderOGL(const char* szFile, aeUInt32 uiOpenGLTextureID, aeUInt32& uiOpenGLTextureType, aeUInt32& uiWidth, aeUInt32& uiHeight, aeUInt32& uiDepth)
  {
        ...
        (aeStringFunctions::FindFirstStringPos(szFile, "%03d") != -1))
    {
      ...
      if (bRGBE)
      {
        glTexImage3D(uiOpenGLTextureType, 0, GL_RGB9_E5, uiWidth, uiHeight, uiDepth, 0, GL_RGB, GL_UNSIGNED_INT_5_9_9_9_REV, nullptr);
      }
      else
      {
        glTexImage3D(uiOpenGLTextureType, 0, GL_RGBA8, uiWidth, uiHeight, uiDepth, 0, GL_RGBA, GL_UNSIGNED_BYTE, nullptr);
      }
