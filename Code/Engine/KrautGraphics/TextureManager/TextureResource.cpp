...
namespace AE_NS_GRAPHICS
{
  ...
  void aeTextureResource::LoadResourceFromFile (const char* szFilename)
  {
    ...
    aeFilePath sFile= aePathFunctions::GetFileName (szFilename);
  ...
  void aeTextureResource::CreateResourceFromDescriptor (void* pDescriptor)
  {
    ...
    if (g_RenderAPI == AE_RA_OPENGL)
    {
      ...
      case AE_TYPE_TEXTURE_CUBE:
        glTexImage2D (GL_TEXTURE_CUBE_MAP_POSITIVE_X_ARB, 0, mapTextureFormatOGL (pTexDesc->m_TextureFormat), pTexDesc->m_uiWidth, pTexDesc->m_uiWidth, 0, getGLDataFormat (pTexDesc->m_TextureFormat), getGLDataType (pTexDesc->m_TextureFormat), NULL);
        glTexImage2D (GL_TEXTURE_CUBE_MAP_NEGATIVE_X_ARB, 0, mapTextureFormatOGL (pTexDesc->m_TextureFormat), pTexDesc->m_uiWidth, pTexDesc->m_uiWidth, 0, getGLDataFormat (pTexDesc->m_TextureFormat), getGLDataType (pTexDesc->m_TextureFormat), NULL);
        glTexImage2D (GL_TEXTURE_CUBE_MAP_POSITIVE_Y_ARB, 0, mapTextureFormatOGL (pTexDesc->m_TextureFormat), pTexDesc->m_uiWidth, pTexDesc->m_uiWidth, 0, getGLDataFormat (pTexDesc->m_TextureFormat), getGLDataType (pTexDesc->m_TextureFormat), NULL);
        glTexImage2D (GL_TEXTURE_CUBE_MAP_NEGATIVE_Y_ARB, 0, mapTextureFormatOGL (pTexDesc->m_TextureFormat), pTexDesc->m_uiWidth, pTexDesc->m_uiWidth, 0, getGLDataFormat (pTexDesc->m_TextureFormat), getGLDataType (pTexDesc->m_TextureFormat), NULL);
        glTexImage2D (GL_TEXTURE_CUBE_MAP_POSITIVE_Z_ARB, 0, mapTextureFormatOGL (pTexDesc->m_TextureFormat), pTexDesc->m_uiWidth, pTexDesc->m_uiWidth, 0, getGLDataFormat (pTexDesc->m_TextureFormat), getGLDataType (pTexDesc->m_TextureFormat), NULL);
        glTexImage2D (GL_TEXTURE_CUBE_MAP_NEGATIVE_Z_ARB, 0, mapTextureFormatOGL (pTexDesc->m_TextureFormat), pTexDesc->m_uiWidth, pTexDesc->m_uiWidth, 0, getGLDataFormat (pTexDesc->m_TextureFormat), getGLDataType (pTexDesc->m_TextureFormat), NULL);
        break;
      default:
