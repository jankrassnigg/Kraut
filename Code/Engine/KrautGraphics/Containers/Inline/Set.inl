...
namespace AE_NS_FOUNDATION
{
  ...
  void aeSet<KEY, COMPARE>::iterator_base::forward(void)
  {
    ...
    {
      AE_CHECK_ALWAYS(m_pElement != nullptr, "aeSet::iterator_base::forward: The iterator is invalid (end).");
      return;
    }
  ...
  void aeSet<KEY, COMPARE>::iterator_base::backward(void)
  {
    ...
    if (m_pElement == nullptr)
    {
      AE_CHECK_ALWAYS(m_pElement != nullptr, "aeSet::iterator_base::backward: The iterator is invalid (end).");
      return;
    }
  ...
  template <class KEY, class COMPARE>
  aeSet<KEY, COMPARE>::aeNode::aeNode(void)
    : m_uiLevel(0)
    , m_pParent(nullptr)
  {
  }
  ...
  typename aeSet<KEY, COMPARE>::iterator aeSet<KEY, COMPARE>::erase(const iterator& pos)
  {
    ...
    AE_CHECK_ALWAYS(pos.m_pElement != nullptr, "aeSet::erase: The iterator (pos) is invalid.");
  ...
  {
    AE_CHECK_ALWAYS(!empty(), "aeSet::erase: The container is empty.");
    AE_CHECK_ALWAYS(pos.m_pElement != nullptr, "aeSet::erase: The reverse_iterator (pos) is invalid.");
