  ...
  */
  ...
  private:
    ...
    struct iterator_base
    {
      ...
      iterator_base(const iterator_base& cc)
        : m_pElement(cc.m_pElement)
      {
      }
      iterator_base(aeNode* pInit)
        : m_pElement(pInit)
      {
      }
  ...
  public:
    ...
    struct iterator : public iterator_base
    {
      ...
      iterator(const iterator& cc)
        : iterator_base(cc.m_pElement)
      {
      }
      iterator(aeNode* pInit)
        : iterator_base(pInit)
      {
      }
    ...
    struct reverse_iterator : public iterator_base
    {
      ...
      reverse_iterator(const reverse_iterator& cc)
        : iterator_base(cc.m_pElement)
      {
      }
      reverse_iterator(aeNode* pInit)
        : iterator_base(pInit)
      {
      }
    ...
    struct const_iterator : public iterator_base
    {
      ...
      const_iterator(const const_iterator& cc)
        : iterator_base(cc.m_pElement)
      {
      }
      const_iterator(const iterator& cc)
        : iterator_base(cc.m_pElement)
      {
      }
      const_iterator(aeNode* pInit)
        : iterator_base(pInit)
      {
      }
    ...
    struct const_reverse_iterator : public iterator_base
    {
      ...
      const_reverse_iterator(const const_reverse_iterator& cc)
        : iterator_base(cc.m_pElement)
      {
      }
      const_reverse_iterator(const reverse_iterator& cc)
        : iterator_base(cc.m_pElement)
      {
      }
      const_reverse_iterator(aeNode* pInit)
        : iterator_base(pInit)
      {
      }
